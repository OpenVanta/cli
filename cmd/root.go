...
Then use resource commands like controls, policies, documents, tests, people, frameworks, users, vulnerabilities, vulnerable-assets, integrations, vendors, risk-scenarios, and monitored-computers.
