...
Then use resource commands like controls, policies, documents, tests, people, frameworks, users, vulnerabilities, integrations, vendors, vendor-risk-attributes, risk-scenarios, and monitored-computers.
