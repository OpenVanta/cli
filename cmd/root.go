...
Then use resource commands like controls, policies, documents, tests, people, groups, frameworks, users, vulnerabilities, integrations, vendors, risk-scenarios, and monitored-computers.
