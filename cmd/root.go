...
Then use resource commands like controls, policies, documents, tests, people, frameworks, users, vulnerabilities, vulnerability-remediations, integrations, vendors, risk-scenarios, and monitored-computers.
