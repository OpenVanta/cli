...
Then use resource commands like controls, policies, documents, tests, people, frameworks, users, vulnerabilities, integrations, vendors, risk-scenarios, monitored-computers, and event-logs.
